...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full h-[8vh] flex flex-col items-center justify-end bottom-0 z-20 lg:w-16 lg:h-max lg:right-[2%] lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2">
