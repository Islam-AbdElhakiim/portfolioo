...
export default async function handler(
  ...
  const options = {
    from: `Islam Abdelhakiim <islamabdelhakiim21@gmail.com>`,
    to: `${name} <${email}>`,
  ...
  >
    ...
    <p>
      <b>Thanks a bunch</b> for taking the time to reach out my <a href="https://islamabdelhakiim.dev">Portfolio</a> and leave a
      message. 🎉
    </p>
    <p>
    ...
    >
      ...
      <a href="https://islamabdelhakiim.dev" style='color:white;'>Portfolio</a>
      <p>+20 01201179651</p>
    </div>
  </div>
    `,
  ...
  try {
    ...
    res.status(500).json({
      ...
      errors: err ?? "error in sending the autoreply ",
    });
  }
}
